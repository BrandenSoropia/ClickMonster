...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PokeContainer = __webpack_require__(160);

	var _PokeContainer2 = _interopRequireDefault(_PokeContainer);
	...
	_reactDom2.default.render(_react2.default.createElement(
	  'div',
	  null,
	  _react2.default.createElement(_PokeContainer2.default, null)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PokeSlot = __webpack_require__(161);
	...
	var PokeContainer = _react2.default.createClass({
	  ...
	  statics: {
	    modifyArrayItemAtIndex: function modifyArrayItemAtIndex(array, activeArraryIdx, item) {
	    ...
	    generateRandomHitpoints: function generateRandomHitpoints(minHitpoints, maxHitpoints) {
	      return Math.floor(Math.random() * (maxHitpoints - minHitpoints) + minHitpoints);
	    },

	    changeValueOfKeyValuePair: function changeValueOfKeyValuePair(keyValuePair, attributeName, replacementItem) {
	    ...
	    generatePokeStatusStruct: function generatePokeStatusStruct(activeSlotIdx, minHitpointsSetting, maxHitpointsSetting) {
	    ...
	    isFainted: function isFainted(pokeStatus) {
	  ...
	  **/
	  onActivateSlot: function onActivateSlot(containerIdx, event) {
	  ...
	  onDeactivateSlot: function onDeactivateSlot(containerIdx, event) {
	  ...
	  onUpdatePokemonStatus: function onUpdatePokemonStatus(containerIdx, event) {
	    ...
	    if (PokeContainer.isFainted(modifiedPokemonStatusInfo)) {
	      ...
	      modifiedActiveSlots = PokeContainer.modifyArrayItemAtIndex(this.state.activeSlots, containerIdx, modifiedPokemonStatusInfo);
	    }
	  ...
	  render: function render() {
	    ...
	    for (var i = 0; i < this.state.activeSlots.length; i++) {
	      ...
	      if (this.state.activeSlots[i] != null) {
	        ...
	        pokeSlots.push(_react2.default.createElement(_PokeSlot2.default, {
	          key: i,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PokeSlot = _react2.default.createClass({
	  displayName: "PokeSlot",
	  ...
	  render: function render() {
	    if (this.props.active) {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement("img", { src: this.props.imagePath, onClick: this.props.train.bind(null, this.props.containerArrayIdx) }),
	        _react2.default.createElement(
	          "button",
	          { onClick: this.props.deactivate.bind(null, this.props.containerArrayIdx) },
	          "Release Pokemon"
	        )
	      );
	    } else {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          null,
	          "Slot: ",
	          this.props.containerArrayIdx
	        ),
	        _react2.default.createElement(
	          "button",
	          { onClick: this.props.activate.bind(null, this.props.containerArrayIdx) },
	          "Get Pokemon"
	        )
	      );
	    }
